...
A collection of skills for AI coding agents working with my projects. 
...
- **Skill directory**: `kebab-case` (e.g., `vps-deploy`, `log-monitor`)
...
```bash
npx skills add ehsanghaffar/skills --skill {skill-name}
```
